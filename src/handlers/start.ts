...
export const WELCOME_MESSAGE =
  ...
  "هذا البوت مساعد لمنصة 3M Academy: يمكنكم التعرف على المحتوى، تصفّح المنتجات، ومتابعة الدعم بسهولة. 💜\n\n" +
...
export async function handleAboutContent(ctx: Context): Promise<void> {
  ...
  const text =
    ...
    "تصفّحوا المنتجات من «🛒 طلب المحتوى». الشراء والوصول إلى المحتوى سيتم عبر منصة 3M Academy.";
